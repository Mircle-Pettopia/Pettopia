...
$(document).ready(function () {
    ...
    //검색어
    $(".headerSearch .frmSearchTop").validate({
        submitHandler: function (form) {
            if ($(".headerSearch .frmSearchTop input[name='adUrl']").val() && $(".headerSearch .frmSearchTop input[name='keyword']").val() == '') document.location.href = $(".headerSearch .frmSearchTop input[name='adUrl']").val();
            else form.submit();
        },
        rules: {
            keyword: {
                required: function () {
                    ...
                    if ($(".headerSearch .frmSearchTop input[name='adUrl']").val()) {
                        return false;o
                    }
                    else {
                        return true;
    ...
    });/*엠플샵 추가*/$("#aside .frmSearchTop").validate({submitHandler:function(e){$("#aside .frmSearchTop").find("input[name='adUrl']").val()&&""==$("#aside .frmSearchTop").find("input[name='keyword']").val()?document.location.href=$("#aside .frmSearchTop").find("input[name='adUrl']").val():e.submit()},rules:{keyword:{required:function(){return!$("#aside .frmSearchTop").find("input[name='adUrl']").val()}}},messages:{keyword:{required:__("검색어를 입력하세요.")}}}),$(".headerSearchMobile .frmSearchTop").validate({submitHandler:function(e){$(".headerSearchMobile .frmSearchTop").find("input[name='adUrl']").val()&&""==$(".headerSearchMobile .frmSearchTop").find("input[name='keyword']").val()?document.location.href=$(".headerSearchMobile .frmSearchTop").find("input[name='adUrl']").val():e.submit()},rules:{keyword:{required:function(){return!$(".headerSearchMobile .frmSearchTop").find("input[name='adUrl']").val()}}},messages:{keyword:{required:__("검색어를 입력하세요.")}}});
...
function gd_resize_frame(obj) {
    if(obj){var iframeHeight = (obj).contentWindow.document.body.clientHeight;
    (obj).height = iframeHeight + 120;}
}
